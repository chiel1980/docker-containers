...
BOT_EXTRA_PLUGIN_DIR = '/etc/err-plugins/'
...
BOT_IDENTITY = {
    # XMPP (Jabber) mode
    'username': 'err@fqdn.xmpp.server',  # The JID of the user you have created for the bot
    'password': '**********',       # The corresponding password for this user
    'server': ('fqdn.xmpp.server',5222), # server override
...
#
BOT_ADMINS = ('mve@chat.pragmasec.nl',)
...
CHATROOM_PRESENCE = ('pragmasec@conference.chat.pragmasec.nl',)
